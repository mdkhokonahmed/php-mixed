...
<h1 class="panel-title">Update Purchases Stock</h1>
</div>
<div class="panel-body">
<div class="row">

<div class="col-lg-10 col-md-offset-2">
{!! Form::open( [ 'url'=>'/update/save', 'method' =>'POST', 'class' =>'form-horizontal', 'name'=>'editCategoryForm' ] ) !!}
...
<table   border="0" cellspacing="0" cellpadding="0"  id="dynamictable">
    ...
    <tr>
        <div class="form-group-md" align="center">
           <td>
           <input name="id" type="hidden" value="{{$PurchasesById->id}}">
           </td>


            <td><strong>Supplier Name</strong></td>

            <td><input class="form-control" name="supplier" type="text" id="supplier"style="width:100px;" value="{{$PurchasesById->supplier}}"></td>
            <td>&nbsp;</td>

            <td><strong>Address</strong></td>
            <td><textarea class="form-control" name="address1" id="address" style="width:100px;">{{$PurchasesById->address1}}</textarea></td>
            <td>&nbsp;</td>
            <td>
                <strong>Phone</strong>
                <br><br><br>
            ...
            <td><input name="phone" class="form-control" type="text" id="phone"  value="{{$PurchasesById->phone}}" style="width:100px;">
                <br>
                <input name="email" class="form-control" type="text" id="email"  value="{{$PurchasesById->email}}" style="width:100px;" >
            </td>
        </div>
    </tr>
    <tr>
...
<table  border="0" cellspacing="0" cellpadding="0"  id="duplicate" style="">
    ...
    <tr>
        <div class="form-group-md" align="right">
            ...
            <td ><input name="name" class="form-control" type="text"  id="0" style="width:120px;" onFocus="callAutoComplete(this.id)"  onBlur="callAutoAsignValue(this.id)" autocomplete="off" value="{{$PurchasesById->name}}"></td>

            <td><div align="right"><strong>Qty</strong></div></td>

            <td><input name="quantity" class="form-control" type="text" id="00" style="width:50px;" onKeyUp="callQKeyUp(this.id)" value="{{$PurchasesById->quantity}}"></td>

            <td><div align="left"><strong>Buy Rate:</strong></div></td>

            <td><input name="brate" class="form-control" type="text" id="000" style="width:80px;" onKeyUp="callRKeyUp(this.id)" value="{{$PurchasesById->brate}}" ></td>

            <td><strong>Sales Rate</strong> </td>

            <td><input name="srate" class="form-control" type="text" id="0000" style="width:80px;" value="{{$PurchasesById->srate}}" ></td>

        
            <td><div align="left"><strong>Total:</strong></div></td>
            <td><input name="total" class="form-control" type="text" id="000000" readonly="" value="{{$PurchasesById->total}}" style="width:120px;text-align:right;"></td>
...
<table  border="0" align="left" cellpadding="0" cellspacing="0"  id="duplicate" style="">
    <div class="form-group-md">
        ...
        <tr>
            ...
            <td><input type="text" class="form-control" name="payment" style="width:100px; " id="payment" class="validate[required,custom[onlyFloat],lengthCheck[6]] text-input" onKeyUp="balanceCalc()" value="{{$PurchasesById->payment}}">
            </td>
            <td><div align="left"><strong>Description</strong></div></td>
            <td rowspan="2"><textarea class="form-control" name="description" style="width:150px; height:70px; ">{{$PurchasesById->description}}</textarea></td>

            <td><strong>Sub Total </strong></td>
            <td>&nbsp;</td>
            <td><input name="subtotal" class="form-control" id="subtotal" type="text" readonly="" style="width:100px; text-align:right; color:#333333; font-weight:bold; font-size:16px;" value="{{$PurchasesById->subtotal}}"></td>
        ...
        <tr>
            ...
            <td><input name="balance" class="form-control" type="text" id="balance" style="width:100px; " value="{{$PurchasesById->balance}}" readonly=""></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
...
<script>
document.forms['editCategoryForm'].elements['mode'].value={{$PurchasesById->mode }}
    </script>

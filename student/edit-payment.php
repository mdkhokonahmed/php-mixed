...
<?php include_once 'inc/sidebar.php';?>
 ...
 <?php
   ...
   if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update'])) {
       ...
       $updatetpay = $payment->UpdatePayment($payId, $_POST);  
      }
...
<div class="col-lg-12">
  <div class="panel panel-primary">
      <div class="panel-heading" align="center">
          <h1 class="panel-title">Update Payment Stock</h1>
          <?php
            if (isset($updatetpay)) {
              echo $updatetpay;
            }
      ...
      <div class="panel-body">
          <div class="row">
              <div class="col-lg-10 col-md-offset-2">
                <?php
                  $getpayment = $payment->GetPaymentById($payId);
                  foreach ($getpayment as $psymentshow) {
                    # code...
                  }
                  ?>
                      ...
                      <table   border="0" cellspacing="0" cellpadding="0"  id="dynamictable">
                          ...
                          <tr>
                              <div class="form-group-md" align="right">
                                  ...
                                  <td> <input class="form-control" name="stdid" value="<?php echo $psymentshow['stdid'];?>" type="text" id="id" style="width:90px;" ></td>
                                  <td>&nbsp;</td>
                      ...
                      <table  border="0" cellspacing="0" cellpadding="0"  id="duplicate" style="">
                          ...
                          <tr>
                              <div class="form-group-md" align="right">
                                  ...
                                  <td ><input name="name" value="<?php echo $psymentshow['name'];?>" class="form-control" type="text"  id="0" style="width:120px;" onFocus="callAutoComplete(this.id)"  onBlur="callAutoAsignValue(this.id)" autocomplete="off"></td>
                       ...
                       <option 
                        <?php 
                         if ($psymentshow['deptId'] == $showdepartment['deptId']) { ?>
                          selected = "selected"
                  ...
                  <td><input name="month" class="form-control" value="<?php echo $psymentshow['month'];?>" type="text" id="00" style="width:50px;" onKeyUp="callQKeyUp(this.id)"></td>

                  <td><div align="left"><strong>Month Rate:</strong></div></td>
                  <td><input name="monthrate" class="form-control" value="<?php echo $psymentshow['monthrate'];?>" type="text" id="000" style="width:80px;" onKeyUp="callRKeyUp(this.id)"></td>

                  <td><div align="left"><strong>Total:</strong></div></td>
                  <td><input name="total" class="form-control" type="text" id="000000" readonly="" value="<?php echo $psymentshow['total'];?>" style="width:120px;text-align:right;" >  </td>
      ...
      <table  border="0" align="left" cellpadding="0" cellspacing="0"  id="duplicate" style="">
          <div class="form-group-md">
              ...
              <tr>
                  ...
                  <td><input type="text" class="form-control" name="payment" value="<?php echo $psymentshow['payment'];?>" style="width:100px; " id="payment" class="validate[required,custom[onlyFloat],lengthCheck[6]] text-input" onKeyUp="balanceCalc()"></td>

                  <td><div align="left"><strong>Description</strong></div></td>
                  <td rowspan="2"><textarea class="form-control" name="description" style="width:150px; height:70px;"><?php echo $psymentshow['description'];?></textarea></td>

                  <td><strong>Sub Total </strong></td>

                  <td>&nbsp;</td>
                  <td><input name="subtotal" class="form-control" value="<?php echo $psymentshow['subtotal'];?>" id="subtotal" type="text" readonly="" style="width:100px; text-align:right; color:#333333; font-weight:bold; font-size:16px;"></td>
              ...
              <tr>
                  ...
                  <td><input name="duetk" class="form-control" value="<?php echo $psymentshow['duetk'];?>" type="text" id="balance" style="width:100px; " value="0.00" readonly=""></td>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
      ...
      <td width="195"><input type="text" class="form-control"  name="duedate" value="<?php echo $psymentshow['duedate'];?>" class="date_input"  style="width:100px;"></td>
              ...
              <tr>
                  ...
                  <td>&nbsp;</td>
                  <td><input type="submit" class="btn btn-primary" name="update" value="Update" onClick="updateSubtotal()" ></td>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>
                  <td>&nbsp;</td>

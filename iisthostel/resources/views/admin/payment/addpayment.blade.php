...
<h1 class="panel-title">Add Payment Option</h1>
</div>
<div class="panel-body">
<div class="row">

<div class="col-lg-10 col-md-offset-2">
 {!! Form::open(['url' => '/paymentstudent', 'method'=>'POST', 'name' => 'salesform', 'id' => 'form1']) !!}
       ...
       <td> <input class="form-control" name="roll" type="text" id="id"   style="width:90px;"></td>
                    <td>&nbsp;</td>
                    <td><strong>Date</strong></td>
                    <td><input class="form-control" type="text" id="datefield" name="datecur" class="date_input" value="<?php echo date('d-m-Y');?>" style="width:100px;"  readonly=""></td>
                    <br>
                    <br>
                </div>
            </tr>
        ...
        <table  border="0" cellspacing="0" cellpadding="0"  id="duplicate" style="">
            ...
            <tr>
                <div class="form-group-md" align="right">
                    <td><div align="left"><strong>Student Name</strong></div></td>

                    <td><input name="stdname" class="form-control" type="text"  id="0" style="width:120px;" onFocus="callAutoComplete(this.id)"  onBlur="callAutoAsignValue(this.id)" autocomplete="off"></td>
          ...
          <select class="form-control" name="deptId" style="width:120px">
                       ...
                       <option value="">{{$department->fullname}}</option>
                      @endforeach
                    ...
                    <td><input name="monthrat" class="form-control" type="text" id="000" style="width:80px;" onKeyUp="callRKeyUp(this.id)" ></td>
        ...
        <table  border="0" align="left" cellpadding="0" cellspacing="0"  id="duplicate" style="">
            <div class="form-group-md">
                ...
                <tr>
                    ...
                    <td><img src="{{asset('public/payment')}}/images/refresh.png" alt="Refresh" align="absmiddle" onClick="updateSubtotal()"></td>
                ...
                <tr>
                    ...
                    <td width="195"><input type="text" class="form-control" name="due" id="datepicker" style="width:100px;" placeholder="dd/mm/year"></td>
                    <td width="77">&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>

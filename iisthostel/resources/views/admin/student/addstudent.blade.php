...
<div class="container">
  ...
  {!! Form::open(['url' => '/savestudent', 'method'=>'POST', 'class' => 'form-horizontal']) !!}
...
<label class="col-sm-4 control-label"><h4 style="color: green" align="left">Room Related info </h4> </label>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        <input type="text" class="form-control" id="pwd" placeholder="Enter Seater" name="seater">
   ...
   <div class="form-group">
      ...
      <div class="col-sm-10">          
     <input type="text" class="form-control" id="pwd" placeholder="Enter Fees Per Month" name="feesmonth">
...
<label class="col-sm-2 control-label"><h4 style="color: green" align="left">Personal info </h4> </label>
    ...
    <div class="form-group">
             ...
             <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="rool">
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="emrcontact">
             ...
             <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="garname">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="garcontact">
